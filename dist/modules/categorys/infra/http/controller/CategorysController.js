...
var ReadCategoryService_1 = __importDefault(require("@modules/categorys/services/ReadCategoryService"));
var CategoryController = /** @class */ (function () {
    function CategoryController() {
    }
    CategoryController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var readCategory, categorys;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        readCategory = tsyringe_1.container.resolve(ReadCategoryService_1.default);
    ...
    CategoryController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var title, createCategory, category;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        title = request.body.title;
                        createCategory = tsyringe_1.container.resolve(CreateCategoryService_1.default);
                        return [4 /*yield*/, createCategory.execute({ title: title })];
                    case 1:
                        category = _a.sent();
