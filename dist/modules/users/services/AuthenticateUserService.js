...
var AuthenticateUserService = /** @class */ (function () {
    ...
    AuthenticateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, IncorrectEmailOrOrPasswordCombination, passwordMatched, _b, secret, expiresIn, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findByEmail(email)];
                    case 1:
                        user = _c.sent();
                        IncorrectEmailOrOrPasswordCombination = 'e-mail or password not valid.';
                        if (!user) {
                            throw new AppError_1.default(IncorrectEmailOrOrPasswordCombination, 401);
                        }
